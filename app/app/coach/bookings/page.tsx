...
export default function CoachBookingsPage() {
  ...
  const [coachTimezone, setCoachTimezone] = useState<string>("America/New_York");
  ...
  const loadBookings = async (coachId: string) => {
    ...
    try {
      ...
      setCoach(coachData);
      setCoachTimezone(coachData?.timezone || coachData?.timeZone || "America/New_York");
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-white font-medium">
                          {displayBookingTime(bookingDate, coachTimezone, "EEEE, MMMM d, yyyy")}
                        </p>
                        <p className="text-gray-400 text-sm">
                          {displayBookingTime(bookingDate, coachTimezone, "h:mm a")} - {displayBookingTime(booking.scheduledEnd.toDate(), coachTimezone, "h:mm a")}
                        </p>
                        <p className="text-xs text-gray-500 mt-1">{coachTimezone}</p>
                      </div>
                    </div>
                    ...
                    {dayBookings.slice(0, 3).map((booking) => {
                      ...
                      return (
                        <div
                          ...
                          title={`${booking.studentName} - ${displayBookingTime(booking.scheduledStart.toDate(), coachTimezone, "h:mm a")}`}
                        >
                          {displayBookingTime(booking.scheduledStart.toDate(), coachTimezone, "h:mm a")} - {booking.studentName}
                        </div>
                      );
                    })}
